...
SCRIPT_PATH="/home/epti/Documentos/epti-dev/bc-channel/bc-git-github/scripts/auto-commit.sh"
CRON_ENTRY="*/5 * * * * $SCRIPT_PATH >> /home/epti/Documentos/epti-dev/bc-channel/bc-git-github/scripts/cron.log 2>&1"
